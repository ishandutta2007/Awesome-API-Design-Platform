...
| Platform | Company | Primary Focus | Key Capabilities | Pricing | Free Tier Limit |
| --- | --- | --- | --- | --- | --- |
| [Postman](https://www.postman.com/) | Postman | API development platform | API design, collections, testing, mocking, documentation and collaboration | From $9/month (Solo plan billed annually, or $12/mo monthly); Team from $19/user/month | Free forever for 1 solo user; includes unlimited collections, unlimited mock servers, 1,000 monitoring requests/month, and 50 AI credits/month |
| [Stoplight](https://stoplight.io/) | Stoplight | API design-first development | OpenAPI design, governance, documentation, mocking and style guides | From $44/month (Basic plan billed annually, or $56/mo monthly; includes 3 users, +$11/user/mo for additional users) | Free forever for 1 user and 1 project with public docs and mock servers; 14-day free trial included on all paid plans |
| [SwaggerHub](https://swagger.io/tools/swaggerhub/) | SmartBear | API design & governance | OpenAPI design, collaboration, versioning, governance and documentation | From $75/user/month (Team plan billed annually; min 2 users = $150/month), or $90/user/month monthly | Free forever for 1 user, up to 3 public APIs/domains, and community support; 14-day free trial of Team/Enterprise plans with full features |
| [ReadMe](https://readme.com/) | ReadMe | Developer portals | API documentation, guides, API explorer, analytics and developer experience | From $250/month (Pro plan billed annually; includes 5 admin seats), or $300/month monthly | Free forever (Starter plan) for 1 project, 3 published versions, 1 admin seat, and readme.io subdomain; 14-day free trial on Pro plan |
| [Apicurio](https://www.apicur.io/) | Apicurio / Red Hat ecosystem | Open API design & registry | OpenAPI, AsyncAPI, visual editing, registry and governance | Free & Open-Source (Apache-2.0); enterprise managed registry on Red Hat OpenShift from ~$216/month ($0.30/hour) | Free forever with unlimited API designs, visual editing, and local browser storage (studio.apicur.io) or self-hosted deployment |
| [Insomnia](https://insomnia.rest/) | Kong | API client & design | OpenAPI design, REST, GraphQL, gRPC, testing and debugging | From $12/user/month (Pro plan billed annually, or $15/user/month monthly); Enterprise at $45/user/month | Free forever (Essentials plan) for 1 user (up to 3 users on Git Sync), 1,000 cloud mock requests/month, unlimited local & cloud projects, and local scratch pad |
| [Kong Insomnia](https://insomnia.rest/) | Kong | API development | API design, debugging, testing, documentation and Git workflows | From $12/user/month (Pro plan billed annually, or $15/user/month monthly); Enterprise at $45/user/month | Free forever (Essentials plan) for 1 user (up to 3 users on Git sync), 1,000 mock requests/month, unlimited collections; 14-day free trial on Enterprise |
| [Apiary](https://apiary.io/) | Oracle | API design & documentation | API Blueprint, mocking, documentation and collaboration | Discontinued (Sunset by Oracle in September 2025; historically started at $99/month for Standard plan) | Service retired in September 2025; historically offered Free plan for 1 user, 1 private API, and unlimited public APIs |
| [RapidAPI Studio](https://rapidapi.com/) | RapidAPI | API development platform | API design, testing, documentation, publishing and API marketplace | From $10/user/month per additional seat beyond 5 seats (Teams plan); Enterprise Hub on custom annual contract | Free forever for first 5 team seats with unlimited API designs, private sharing, and testing; marketplace API consumption limits set per API provider |
| [Speakeasy](https://www.speakeasy.com/) | Speakeasy | SDK/API development | OpenAPI tooling, SDK generation, API design and developer experience | From $250/month (Team plan per language SDK target); Business plan at $600/month | Free forever for 1 SDK target language, core CLI generation, and automated GitHub publishing workflows; 14-day free trial on paid plans |
| [Redocly](https://redocly.com/) | Redocly | API documentation & governance | OpenAPI, docs, linting, API registry and developer portals | From $10/seat/month (Pro plan billed annually); hosted developer portal from $300/month | Free forever (Starter tier) for 1 project, unlimited API operations, community support, and core 3-panel API reference docs; 14-day free trial on portals |
| [Bump.sh](https://bump.sh/) | Bump.sh | API documentation | OpenAPI docs, changelogs and API contract workflows | From $50/month (Basic plan; includes 10 API docs and 5 MCP tools) or $120/month (Pro plan) | 14-day free trial with full access to Pro features (30 API docs, 50 MCP tools, branches management, API explorer, and full CI integration); free for open source |
| [Fern](https://buildwithfern.com/) | Fern | API development | API definitions, SDK generation and documentation | From $150/month (Team plan billed annually, or $180/month monthly; up to 5 members) | Free forever (Hobby plan) for up to 2 team members, 250 AI credits/month, custom domain, API reference docs, guides, changelogs, and API explorer |
| [Mintlify](https://mintlify.com/) | Mintlify | Developer documentation | API documentation, reference docs and developer portals | From $450/month (Pro plan billed annually, or $540/month monthly; includes unlimited editor seats and 10,000 AI credits/month) | Free forever (Starter/Hobby plan) for 1 dashboard member, 1 project, custom domain, and web editor (excludes AI assistant and AI credits) |
| [Scalar](https://scalar.com/) | Scalar | API references & tooling | OpenAPI docs, API client and developer experience | From $125/month (Pro plan billed yearly, or $150/month monthly; includes 5 editor seats, up to 15 APIs, 1 SDK up to 100 endpoints) | Free forever for 1 editor seat, up to 3 APIs in registry, 1 SDK up to 25 endpoints, 50 Agent Scalar credits, and subdomain hosting; open-source (MIT) for self-hosting |
| [Apidog](https://apidog.com/) | Apidog | All-in-one API development | API design, testing, mocking, documentation and collaboration | From $9/user/month (Basic plan billed annually, or $12/user/month monthly); Professional at $18/user/month | Free forever for up to 4 users with full core features, unlimited test runs, unlimited APIs, unlimited requests, and unlimited mock server calls |
| [Stoplight Elements](https://stoplight.io/open-source/elements) | Stoplight | API documentation | OpenAPI reference rendering | Free & Open-Source (Apache-2.0); hosted cloud solution via Stoplight Platform starting at $44/month | Free forever and unlimited for open-source self-hosting and embedding; hosted via Stoplight Free plan (1 user, 1 project, public docs) |
...
| [Swagger Editor](https://editor.swagger.io/) | SmartBear | API design | Browser-based OpenAPI editing and validation | Free & Open-Source (Apache-2.0); hosted collaborative team solution is SwaggerHub starting at $75/user/month | Free forever and unlimited for browser-based editing at editor.swagger.io; hosted via SwaggerHub Free plan (1 user, 3 public APIs) |
